...
public class ForgeNetworkPlatform implements NetworkPlatform {
    ...
    public <T> void registerClientBoundPacket(Class<T> msgClass, ResourceLocation id,
        ...
        ForgeNetworking.registerPacket(msgClass, encoder, decoder, handler, NetworkDirection.PLAY_TO_CLIENT);
    }
    ...
    public <T> void registerServerBoundPacket(Class<T> msgClass, ResourceLocation id,
        ...
        ForgeNetworking.registerPacket(msgClass, encodeFunc, decodeFunc, handler, NetworkDirection.PLAY_TO_SERVER);
    }


    @Override
    public <T> void sendToPlayer(T message, ServerPlayer player) {
        ForgeNetworking.sendToPlayer(message, player);
    }

    @Override
    public <T> void sendToServer(T message) {
        ForgeNetworking.sendToServer(message);
    }
}
*///?}